...
var url = "history_json.php?status=1";
...
function chart2date( begin, end, device){
	//mychart.Destroy();
	//var history = document.getElementById('historygraph').getContext('2d');
	//mychart = new Chart(history);
	mychart.destroy();
	...
	var url = "history_json.php?status=2&begin="+begin+"&end="+end+"&device="+device+"";
	console.log(url);
	}
xmlhttp.onreadystatechange=function() {
    if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
...
function createtable(begin,end,device){
	...
	var url = "history_json_table.php";
		...
		var url = "history_json_table.php?status=2&begin="+begin+"&end="+end+"&device="+device+"";
	}
xmlhttp.onreadystatechange=function() {
    if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
        myFunction(xmlhttp.responseText);
...
for (var i = 0; i < jsonData.history_table.length; i++) {
  ...
  <body onload="chart7day()">
  <div id="wrap">
  <div id="regbar">
    <div id="navthing">
      <h2><a href="monitor.php" id="loginform">Monitoring</a> | <a href="network.php">Network</a>  | <a href="location.php">Device Information</a> | <a href="history.php" ><u>History</u></a> | <a href="user.php">User</a> | <a href="logout.php">Logout</a></h2>
    <!--<div class="login">
...
<br>
<table width="800" border="0" bgcolor="#B6B6B4" id="myTable">
	<tr>
		<td>No</td>
		<td>Hostname</td>
		<td>MAC Address</td>
		<td>Location</td>
		<td>Downtime (Date)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Downtime (Days)</td>
	</tr>
	</table>
    </div>
